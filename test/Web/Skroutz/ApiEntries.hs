...
apiEntries =
  ...
  .*. ("autocomplete" :: String, "http://api.skroutz.gr/autocomplete?q=iph" :: String, withStdParams $ Skroutz.getAutocompletes "iph", Proxy :: Proxy Skroutz.MultipleAutocompleteResponse)
  .*. ("search_category_match" :: String, "http://api.skroutz.gr/search?q=Tablets" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "Tablets", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_manufacturer_match" :: String, "http://api.skroutz.gr/search?q=apple" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "apple", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_latin_mapping" :: String, "http://api.skroutz.gr/search?q=ιπηονε" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "ιπηονε", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_spelling" :: String, "http://api.skroutz.gr/search?q=ipone" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "ipone", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_drop" :: String, "http://api.skroutz.gr/search?q=wrong+iphone" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "wrong iphone", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_no_results" :: String, "http://api.skroutz.gr/search?q=asdf" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "asdf", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_category_facade" :: String, "http://api.skroutz.gr/search?q=iphone" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "iphone", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_sku_match" :: String, "http://api.skroutz.gr/search?q=nikon+1+j2" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "nikon 1 j2", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
  .*. ("search_skus_match" :: String, "http://api.skroutz.gr/search?q=samsung+galaxy+s5+16GB" :: String, withStdParamsPagedDefaults $ Skroutz.getGeneralSearchResult "samsung galaxy s5 16GB", Proxy :: Proxy Skroutz.MultipleGeneralSearchResultResponse)
